...
EXPECTED_PATHS = (
    ...
    "agency eval product",
    "agency eval routing",
    "agency eval shadow-recall",
    "agency eval spawn-authority",
    "agency eval staffing",
...
EXPECTED_BINDINGS = {
    ...
    "agency chaos run": "cmd_chaos_run",
    ...
    "agency eval staffing": "cmd_eval_staffing",
    "agency eval full-roster": "cmd_eval_full_roster",
    "agency eval shadow-recall": "cmd_eval_shadow_recall",
    ...
    "agency evidence child-launches": "cmd_evidence_child_launches",
...
EXPECTED_MANIFEST_SHA256 = "8af042ecef9a66a5df48f11811f40638442adea4707d98de86ddab87660d9b61"
