...
CODEX_CANARY_DEVELOPER_INSTRUCTIONS = (
    ...
    "previously delivered review directly, use no tools, and return one concise sentence. "
    ...
    "path returned by spawn_agent, with message set to the row's JSON-decoded exact "
    "execution_message, and call wait_agent once more with a 60000 ms timeout for the "
