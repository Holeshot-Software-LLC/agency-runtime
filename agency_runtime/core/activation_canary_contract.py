...
CODEX_ACTIVATION_CANARY_WAIT_TIMEOUT_MS = (
    _CODEX_ACTIVATION_CANARY_CHILD_JUDGE_CALL_BUDGET
    * _CODEX_ACTIVATION_CANARY_CHILD_JUDGE_TIMEOUT_MAX_MS
    + _CODEX_ACTIVATION_CANARY_CHILD_COMPLETION_MARGIN_MS
)
