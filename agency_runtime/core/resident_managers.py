...
RESIDENT_MANAGER_KERNEL_VERSION: Final[int] = 5
# v5 added the one-line roster awareness (AR-355); the budget rose with it.
MAX_RESIDENT_MANAGER_KERNEL_CHARS: Final[int] = 1280
...
[Agency resident-steward kernel v5]
