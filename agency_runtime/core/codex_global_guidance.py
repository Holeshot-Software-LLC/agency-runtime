...
def render_codex_global_guidance() -> str:
    ...
    return (
        ...
        "goal. Use the canonical child path returned by spawn and make its execution turn "
        "self-contained by concatenating that row's exact execution-message prefix with "
        "the same exact goal. Respect dependency order and required waits. Do not merge, omit, "
