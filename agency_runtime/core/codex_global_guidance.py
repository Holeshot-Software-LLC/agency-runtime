...
def render_codex_global_guidance() -> str:
    ...
    return (
        ...
        "goal. Use the canonical child path returned by spawn for that row's exact execution "
        "message, and respect dependency order and required waits. Do not merge, omit, "
