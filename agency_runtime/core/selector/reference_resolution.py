...
_GENERIC_URL_PARTS: Final[frozenset[str]] = frozenset(
    {
        "www", "com", "org", "net", "io", "ai", "dev", "app", "co", "uk", "en",
        "us", "http", "https", "index", "html", "htm", "php", "latest", "main",
        "master", "docs", "doc", "download", "downloads", "dist", "release",
        "releases", "v1", "v2", "api", "static", "assets", "page", "home",
    }
)
