...
# Redaction moved to core: every capture path needs it, and while it lived here
# only this adapter applied it. Re-exported so existing importers keep working.
from agency_runtime.core.content_redaction import (
    MAX_CAPTURE_CHARS,
