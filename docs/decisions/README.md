...
| [ADR-0245](0245-preserve-complete-inferred-teams-during-delivery.md) | Preserve complete inferred teams during delivery | accepted |
| [ADR-0244](0244-deliver-large-hermes-card-sets-through-native-tools.md) | Deliver large Hermes card sets through native tools | accepted |
...
| [ADR-0197](0197-form-the-retrieval-subject-before-the-turn-that-needs-it.md) | Form the retrieval subject before the turn that needs it | Accepted |
| [ADR-0198](0198-waive-the-typed-requirements-the-roster-declares-but-cannot-serve.md) | Waive the typed requirements the roster declares but cannot serve | Accepted |
...
| [ADR-0237](0237-isolate-claude-bootstrap-from-agency-evaluation.md) | Isolate Claude bootstrap from Agency evaluation | Accepted |
