...
# ADR-0166: Delegate exact schema translation to LiteLLM

## Context

ADR-0165 kept LiteLLM requests in JSON-object mode because an opaque alias does
...
provider fallback, or an actual-model claim. ADR-0165's standardized
