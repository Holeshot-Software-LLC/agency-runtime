...
| [AR-148](issue-AR-148-fail-malformed-remediation-signatures-closed.md), [AR-323](issue-AR-323-remove-stale-ledger-schema-literals.md) | Existing signature fix; schema tests corrected, acceptance pending | The signature guard was already implemented. Three known ledger cases and seven migration/credential cases fail only on copied schema-46 literals. Replace those output assertions with canonical SCHEMA_VERSION, retain legacy 44/45 inputs and every behavioral guard. All 401 selected tests and fresh 1030-test spine pass; three existing spine skips. No production or schema change. AR-347's existing AR-323 tracker exemption supersedes its old future-tracker clause. |
