...
| 36 | AR-177 | Retire the duplicate mandatory manual-CI completion checklist under ADR-0234/AR-186, not accepted. Manual-only behavior remains implemented at 60543e1; 222 current focused contracts pass with five Windows-named deselections. The one retained manual hosted run failed whitespace validation before coverage/compatibility. Preserve its complete job readback and all seven original checkbox states; no billing, workflow, runtime or 97-percent change. | Normal PR/merge before AR-178. Counts: 40 mapped plus 78 legacy = 118. No exhaustive dispatch or claimed successful manual topology. |
