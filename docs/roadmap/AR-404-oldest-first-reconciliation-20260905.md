...
| 37 | AR-178 | Retain open as explicitly deferred, non-blocking post-production research under ADR-0102. All six scenario definitions and the strict live-trial validator exist, but no complete matched blind-graded six-application study is established. All original criteria/states remain. No evaluator deletion, new release gate or study spend. | Tracker #153 remains open. Publish reconciliation, then AR-180. Separate fanout diagnosis files AR-407/#727 for a reproduced scoped-install warning defect; that new mapped record brings the queue to 119 (41 mapped/78 legacy), not a reversal of AR-177 retirement. |
