...
| 45 | AR-191 | Retire obsolete July V2 grant checklist under ADR-0236, superseded by AR-255, not accepted. Exact aliases, argument preservation, exit-code fidelity and existing-Store guards remain. Grant API removed at b222414b; invalid explicit-turn fallback deliberately rejected at 7e1b3603. Original eight checked/one unchecked states remain verbatim. Fresh 23 offline cases pass; reused AR-180 proof is only restricted one-card exec. | [PR #741](https://github.com/Holeshot-Software-LLC/agency-runtime/pull/741) merged a8c2ca54 at00:33:11Z September8, read back. Removes one exempt legacy checklist, not a mapped tracker; no fresh global count claimed. AR-180/AR-255 remain open and no original criterion is newly judged satisfied. |
| 46 | AR-192 | Implemented fail-fast trust preflight remains relevant. Reconcile original criteria 1/2/6 explicitly under ADR-0173 and preserve their original text; no private trust writes, bypass substitution or grant restoration. Fresh180 tests pass, source-equivalent spine1085/three skips. After exact4db6be16 reinstall, real native inspection finds8modified/0trusted in0.542s; actual verification refuses in3.488s with model_invocation_attempted=false. Full sanitized JSON/digests retained. | Retain in_progress: supported owner approval of the settled hashes, authoritative8/8 trusted inspection and successful no-bypass current-profile canary remain. Old23:33 trusted hashes do not transfer across reinstall. No acceptance run, unchanged retry, tracker action or count change. [PR #742](https://github.com/Holeshot-Software-LLC/agency-runtime/pull/742) retains the evidence after AR-191 and before AR-194. |
| 47 | AR-194 | Existing cross-interpreter inspection and strict execution preparation remain implemented. Fresh 116 focused tests/42 deselections pass; actual installed Linux systemd status is owned/current/active/reachable with no repair needed. Four inspection/CLI modules match source. ADR-0117 removes only the obsolete AR-196 presence dependency reciprocally; all five original criterion states remain. | Retain in_progress for native Windows stale-task/runtime repair and post-repair reachability. [PR #743](https://github.com/Holeshot-Software-LLC/agency-runtime/pull/743) merged cbba0fd9 at00:42:58Z September8, read back. No owner mutation, native Windows execution, acceptance verdict or queue-count reduction. |
