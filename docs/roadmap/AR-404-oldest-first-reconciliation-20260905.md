...
| 21 | AR-159 | Retain open: September 7 main unprotected, no rulesets including parents, no current check runs/status contexts. Source aggregate/security contracts pass 104 focused cases. Latest listed CI/CodeQL are August 31/cancelled; historical billing cause is not freshly established. All seven original criteria remain; owner approval, current check/app identities and bypass/readback proof required. | Read-only receipt and owner plan recorded; normal PR pending. No hosted settings or count change: 40 actual trackers plus 89 unfinished legacy records. |
