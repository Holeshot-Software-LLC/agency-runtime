...
| 26 | AR-165 | Real malformed-input gap repaired: strict duplicate-free bounded UTF-8 JSON and array success shape. Four reproduced false classifications now fail closed. Focus 62, full non-Windows workflow 235, fresh spine 1085/three existing skips pass. Both permitted paths and action pins unchanged. ADR-0228 explicitly reconciles only measurement/tracker criteria 8/9, preserving originals. | Nine current criteria await candidate-bound isolated review. Current public API access is not hosted success or a savings claim. No count change: 40 mapped plus 86 legacy = 126. |
