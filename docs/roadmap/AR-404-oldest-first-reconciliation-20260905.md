...
| 35 | AR-176 | Repair seven main-reproduced stale cases and strengthen namespace argument assertions in five test files. Final 15-module package 525/one skip/64 Windows-named deselections, spine 1085/three skips, UI 224/current floors, Node 36 and real authority/namespace 60 pass. No product or coverage-control change. | Retain in_progress: second/final review satisfies six criteria; 2 and 5 lack complete original-double/argument and historical-module inventories. Both verdict rounds preserved; no third review. Publish repairs through one PR/merge, then AR-177. Counts remain 119 (40 mapped/79 legacy). Actual Codex activation and OpenClaw ordinary staffing/header tests pass separately; Claude/Hermes failures remain explicit. |
