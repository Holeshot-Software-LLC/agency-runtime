...
Claude MCP retrieval and exact final-card bytes. It is not installed or accepted
yet. OpenClaw's documented observer permission was corrected; one bounded probe
