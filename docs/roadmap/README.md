...
| `AR-161` | [Sign and license Windows operator-presence delivery](issue-AR-161-sign-and-license-windows-operator-presence-delivery.md) | blocked | p0 | release | pending authorization |
...
| [AR-60](issue-AR-60-frozen-executable-identity.md) | [`e5f4a8c`](../worklog/README.md) | [ADR-0038](../decisions/0038-refuse-executable-git-configuration-during-delegation.md), [ADR-0055](../decisions/0055-freeze-executable-identity-before-launch.md) |
...
| [AR-107](issue-AR-107-build-release-artifacts-from-canonical-git-blobs.md) | [`46f203a`](../worklog/README.md), [`bb8ce93`](../worklog/README.md), [`9f98db3`](../worklog/README.md), [`3515d4e`](../worklog/README.md), [`a869e51`](../worklog/README.md), [`55c4dfe`](../worklog/README.md), [`280b0b7`](../worklog/README.md) | [ADR-0037](../decisions/0037-layered-pinned-supply-chain-gates.md), [ADR-0074](../decisions/0074-build-byte-deterministic-release-artifacts.md) |
...
| [AR-121](issue-AR-121-inference-planning-and-staffing.md) | `4e0b0a7`, `71405fa`, `743a982` | [ADR-0080](../decisions/0080-plan-before-recruiting-from-the-whole-workforce.md), [ADR-0083](../decisions/0083-use-capability-indexed-recall-and-bounded-inference.md) |
...
| [AR-143](issue-AR-143-require-operator-presence-for-controls.md) | `24948a0`, `c741b24`, `0b9849c`, `4620204`, `900f8d3` | [ADR-0096](../decisions/0096-require-operator-presence-for-persistent-controls.md) |
...
| [AR-159](issue-AR-159-enforce-production-branch-protection.md) | `dca7af5`; hosted enforcement pending authorization | [ADR-0037](../decisions/0037-layered-pinned-supply-chain-gates.md), [ADR-0097](../decisions/0097-gate-expensive-ci-fanout-behind-quality-contracts.md) |
| [AR-160](issue-AR-160-publish-platform-honest-native-release-artifacts.md) | local host-profile builder, producer/merge workflow, three-artifact verifier, and tests in progress; hosted cross-OS proof and tracker creation pending | [ADR-0074](../decisions/0074-build-byte-deterministic-release-artifacts.md), [ADR-0098](../decisions/0098-pair-portable-and-win-amd64-wheels.md) |
| [AR-161](issue-AR-161-sign-and-license-windows-operator-presence-delivery.md) | blocked on owner publisher identity and authorized legal review; tracker creation pending authorization | [ADR-0099](../decisions/0099-separate-reproducible-unsigned-builds-from-signed-delivery.md) |
| [AR-162](issue-AR-162-collapse-unavailable-codeql-fanout.md) | one capability preflight, unchanged available-language matrix, unavailable evidence artifact, stable aggregate, and adversarial local contracts; hosted measurement and tracker creation pending | [ADR-0037](../decisions/0037-layered-pinned-supply-chain-gates.md), [ADR-0097](../decisions/0097-gate-expensive-ci-fanout-behind-quality-contracts.md) |
| [AR-163](issue-AR-163-reopen-stale-remediation-authority.md) | fail-closed current-eligibility projection, disjoint stale-authority telemetry, and adversarial local contracts in progress; tracker creation pending | [ADR-0066](../decisions/0066-package-audited-roster-and-sync-quarantined-deltas.md) |
| [AR-164](issue-AR-164-reject-repository-ancestor-path-poisoning.md) | inert repository-ancestor discovery, discovery/final-candidate exclusion, launch-surface integration, and adversarial local contracts in progress; tracker creation pending | [ADR-0055](../decisions/0055-freeze-executable-identity-before-launch.md) |
| [AR-166](issue-AR-166-truthful-dashboard-disclosure-and-correlation.md) | read-only provider rendering, safe user-visible request correlation, and precise runtime-capture disclosure; tracker creation pending | [ADR-0027](../decisions/0027-authoritative-runtime-evidence-traces.md), [ADR-0029](../decisions/0029-secure-local-dashboard-and-bounded-observability.md), [ADR-0096](../decisions/0096-require-operator-presence-for-persistent-controls.md) |
| [AR-165](issue-AR-165-fail-ambiguous-dependency-review-capability-closed.md) | exact bounded dependency-review capability classification, non-equivalent fallback labeling, stable aggregate, and adversarial local contracts; hosted validation and tracker creation pending | [ADR-0037](../decisions/0037-layered-pinned-supply-chain-gates.md), [ADR-0097](../decisions/0097-gate-expensive-ci-fanout-behind-quality-contracts.md) |
| [AR-117](issue-AR-117-parallelize-pr-verification.md) | `49e8f99`, `e0870fa`, `1b28e89`, `e2cb50d`, `6f97dcc`, `aefeb28`, `afd7199`, `dca7af5` | [ADR-0030](../decisions/0030-versioned-quantitative-evaluation-gates.md), [ADR-0097](../decisions/0097-gate-expensive-ci-fanout-behind-quality-contracts.md) |
