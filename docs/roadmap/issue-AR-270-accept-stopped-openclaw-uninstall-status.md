...
# AR-270: Accept stopped OpenClaw uninstall status
...
AR-265, but the separate uninstall classifier still requires exit 0 and
...
- AR-265 stopped-gateway classifier contract.
