...
candidate_commit: 3269ff67d219f8efabbed27e9f1e2cbd48c71a78
...
| R6 | claude | unproven | proven | proven | unproven | unproven | Inference hiring receipt independent critic receipt immutable identity and host-backed use | the `f2f3ca88`-era organic mint of `function-naming-advisor` binds runtime `2cd29815` and is prior-candidate context; an organic hiring gap has not yet recurred on this runtime | 2026-08-18 | `tests/test_contractor_minting_host_parity.py:297-333` | Installed/Live demoted by the candidate advance; an organic hire cannot be restaged on demand, so re-proof waits for a live gap |
...
| R9 | claude | unproven | proven | proven | unproven | unproven | Aggregate of every R1 through R8 cell under one exact candidate identity | R1-R5 and R7 are proven at all four layers on claude at this candidate; R6 Installed/Live await an organic hiring recurrence and R8 Installed/Live await a clean unstaffed-turn publication artifact | 2026-08-18 | `docs/roadmap/AR-119-rule-host-evidence-matrix.md` | Six of eight rules fully proven on this host; R6 and R8 gaps keep the aggregate unproven |
