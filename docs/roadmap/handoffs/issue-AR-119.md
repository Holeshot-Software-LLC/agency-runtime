...
The exact restart-safety input is terminally retained and cannot be retried unchanged. The repair is installed; use a fresh session and genuinely new bounded read-only work unit before touching Hermes.
