...
related:
  ...
  - docs/decisions/0169-deliver-openclaw-native-errors-through-exact-terminal-evidence.md
...
including installer refusal when the middleware contract is absent. ADR-0168
...
Change only Agency's OpenClaw adapter as specified by ADR-0168 and ADR-0169. Do not expose
...
- ADR-0168 selects OpenClaw's awaited tool-result middleware for exact snapshot
