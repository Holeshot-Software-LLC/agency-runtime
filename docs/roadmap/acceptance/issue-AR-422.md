...
|---|---|---|---|---|---|
| 1 | satisfied | `AR-422.1-20260909-5c1ffbd2` | `e4918a1cc25727c804604c95909787ccfbd5386b9df497246ee705f801c7bc9b` | 2026-09-09 | docs/roadmap/evidence/AR-422-claude-native-install-20260909.json exists at the snapshot and matches the excerpt: exact npm update receipt (2.1.257 to 2.1.266), observed group-writable modes 0775 with umask 0002, and a bounded offline npm fixture with per-path modes, exit codes and verbatim stderr. |
| 2 | satisfied | `AR-422.2-20260909-cf39abc7` | `2e3d4c3bb07552011d24bdf148e4e1edef20b6486ea4dd73cefc08c4c024d6e2` | 2026-09-09 | Evidence JSON lines 44-88 show supported `claude install 2.1.266` under umask 0077, exit 0, 0o700 parents, empty native_gate_reason, agency_refresh_ok true, plus same-binary update_survival; its limits and the worklog approach confirm no npm config, hooks, staffing settings or terminals changed. |
| 3 | satisfied | `AR-422.3-20260909-07011029` | `244467bd16fea3b5357e99fcb175774937e1bb285985525a8bec5e112fab455e` | 2026-09-09 | AR-422-claude-native-install-20260909.json:71-87 shows a same-version native reinstall under the original 0002 umask with exit 0, passing native gate and identical binary sha256; AR-404-claude-suite-after-repair-20260909.json:1-384 shows a fresh accepted after_repair Claude run with exact card. |
