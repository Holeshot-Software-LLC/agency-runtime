...
| 3 | satisfied | `AR-398.3-20260905-2847a3f6` | `487ad8e0f34fa4d7f4be54623a1e2ecb926deb30a0cff4ed7e1beeb2779a7850` | 2026-09-05 | AR-398-evidence-20260905.txt:33-47 shows copy h replayed on a store copy closing with a receipt of seven hiring codes and an event per gap unit including the hired one (PL/I prompt, same six-unit mainframe shape); preflight_failure.py:383-415 and tests 442-478 back the per-code fix. |
