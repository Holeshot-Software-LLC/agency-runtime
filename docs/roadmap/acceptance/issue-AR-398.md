...
| 1 | file | `schema 49 widens the receipt CHECK and a pre-49 store is rebuilt in place with its triggers recreated` | 2026-09-05 | `agency_runtime/core/store/schema.py:5049-5088` |
...
| 1 | command-output | `the loss measured before the change, and copies e, f, g and h all closing inside the lease with a receipt` | 2026-09-05 | `docs/roadmap/acceptance/evidence/AR-398-evidence-20260905.txt:4-9` |
...
| 2 | command-output | `copy h: the sixth unit not_attempted with hiring_lease_budget_exhausted, the receipt carrying it, the turn closed at 390 s` | 2026-09-05 | `docs/roadmap/acceptance/evidence/AR-398-evidence-20260905.txt:36-47` |
...
Criterion 3 originally asked for a hiring case per proposed hire; a fail-open
