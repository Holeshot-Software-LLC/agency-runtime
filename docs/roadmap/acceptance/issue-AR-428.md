...
| 3 | satisfied | `AR-428.3-20260909-c8068ebd` | `f5675588345c9957a6126d46e944de7d31922a80426dad43af7c59afce35373b` | 2026-09-09 | Validation JSON (focused 164/1, production 1151/3, conformance 188/188) matches the focused/production/conformance files in the snapshot; observed-plan (four units, static review, no test-evidence unit), the failed receipt with exact invocation, and byte-exact observer restoration show the boundary. |
