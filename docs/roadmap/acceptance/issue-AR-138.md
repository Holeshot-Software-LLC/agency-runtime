...
| 2 | test | Browser abort injection requires retained revision, visible stale notice and successful recovery | 2026-09-07 | scripts/verify_dashboard_browser.mjs:112-129 |
...
| 4 | test | Browser check requires a real control poll and compares focused field, selection, value and all open settings details | 2026-09-07 | scripts/verify_dashboard_browser.mjs:86-108 |
...
| 5 | test | Real browser checks seven loaded views at desktop, intermediate and 375 px widths with axe and geometry assertions | 2026-09-07 | scripts/verify_dashboard_browser.mjs:30-84 |
| 5 | test | The test fixture requires the installed package identity and denies server outbound calls while serving real wheel assets | 2026-09-07 | scripts/verify_dashboard_browser.py:21-94 |
...
| 6 | test | Real browser network failure requires the same safe UUID in notice and application console | 2026-09-07 | scripts/verify_dashboard_browser.mjs:112-129 |
