...
|---|---|---|---|---|---|
| 1 | satisfied | `AR-176.1-20260907-98f48972` | `3d70bb8fb8221f9c2326508cfcb8d361469be689a7116c7ce1bfceec9beea87e` | 2026-09-07 | tests/conftest.py:173-213 explicitly removes AGENCY_DB_PATH for configuration-identity tests; the marked OpenClaw test asserts the configured database path, and the cited combined run reports 525 passed. |
| 2 | absent | `AR-176.2-20260907-0203abd5` | `9b6a59a81c11b6360b45dd9430f8a95da7ebe6d9322b7136969f55b4f737e293` | 2026-09-07 | tests/test_executable_namespace_security.py:578-661 checks current_directory and forbidden_roots in two doubles, but neither excerpt establishes every production argument or all relevant doubles; the passing test summary cannot establish completeness. |
| 3 | satisfied | `AR-176.3-20260907-c079fc30` | `5250743972b1199a52424999e6155e79043657ab16a2c2f67e25d7b9e9b49177` | 2026-09-07 | The cited tests create the resolved file, supply immutable event IDs, and activate real Store snapshots for rollback with current version/hash checks; the combined test artifact reports 525 passed. |
| 4 | satisfied | `AR-176.4-20260907-6075b1c6` | `2a918f3512b091801aec3432b4d73d0bfa3d231c9595f04e862d4dabf61a57dd` | 2026-09-07 | smoke.py:250-285 preserves distinct missing and non-runnable Node diagnostics with frozen argv and immediate launch revalidation; test_doctor.py:361-378 and test_smoke_coverage_complete.py:83-109 assert the diagnostic outcomes. |
| 5 | absent | `AR-176.5-20260907-0e1720be` | `ac4eaa5ddd692fd62c4f8f00f699f65e86abf83c3227b201b34f2fe5a073468a` | 2026-09-07 | The July worklog preserves the repair and exact results, but the current 525-pass report does not identify which modules were affected in July, so its claim of complete module coverage cannot be verified. |
| 6 | satisfied | `AR-176.6-20260907-465c4f51` | `25d12d538d107e9c6b13cb5f93f16d4db1dd7c15123d60a3c430f7754e958c77` | 2026-09-07 | AR-176-fixture-contracts-20260907.md:563-584 records all fifteen modules in one ordered pytest invocation with -W error and explicit Windows exclusion, reporting 525 passed, 1 skipped, and 64 deselected. |
| 7 | satisfied | `AR-176.7-20260907-1f93df94` | `260eb33369dbeeb4ba0a321634faae02e87509c82033b05a057e28ec87358d03` | 2026-09-07 | The cited test excerpts enforce removed-tool rejection, terminal responses, no inference fallback and filesystem guards; AR-176-fixture-contracts-20260907.md records six original failures, the cleanup failure and seven passing cases. |
| 8 | satisfied | `AR-176.8-20260907-5912e47e` | `73c56920443699150d237e0cfd182ba8e0c711b231a69e2eede8bf0562456589` | 2026-09-07 | AR-176 receipts show focused, fast-spine, UI-floor and strict checks passing; AR-404 separately records live failures without injection claims, while ADR-0105/0224 preserve optional diagnostics and distinguish historical evidence. |
