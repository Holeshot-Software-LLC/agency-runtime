...
|---|---|---|---|---|---|
| 1 | satisfied | `AR-150.1-20260907-ef57df36` | `e35b026b4324a08496e5f40a944a8fac10e4b5d0c46ccd00d1f063768377de7a` | 2026-09-07 | dashboard-live.js guards commits with shared generations and abort checks; dashboard_ui.test.mjs demonstrates newer filters surviving deferred control/full responses and newer worker views surviving both cross-scope response orders. |
| 2 | satisfied | `AR-150.2-20260907-50cfd5f0` | `795252768361d04d86034b16528fb6f437933f771f42d1870303fa482170f20e` | 2026-09-07 | dashboard-live.js guards commit ownership, and dashboard_ui.test.mjs tests both refresh directions and response orders with aborted responses delivered, asserting compatible revisions; the cited proof records all four tests passing. |
| 3 | satisfied | `AR-150.3-20260907-a199e8cf` | `ed1fcfa74d7bb411c81c5c97e4b3e3eea065d0f52fd0f1fdd84542abce13946c` | 2026-09-07 | dashboard_ui.test.mjs covers cancellation, rejected stale generations, last-good retention and stale indicators; dashboard-core.js preserves interaction state, and the AR-138 browser receipt confirms polling preservation and failure recovery. |
| 4 | satisfied | `AR-150.4-20260907-e12149b0` | `ec89cf1cc6d7c1539d5822b25071c8224ddb9fcf11dc7beebd8fe63bdf17989d` | 2026-09-07 | The current-checks excerpt records 176 UI passes with 96.93/86.70/95.71 coverage above CI’s 95/86/93 floors; current-verification records 180 server integration passes, with unchanged Python source and tests. |
