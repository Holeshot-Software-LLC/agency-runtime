...
- The owner dashboard bearer is not proof of human presence when a model can
  control that browser session. AR-143 keeps production blocked until owner
  mutation endpoints are removed or gated by OS-backed single-use presence.
